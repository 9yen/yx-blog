...
// BlogArticlesColumns defines and stores column names for table blog_articles.
...
// blogArticlesColumns holds the columns for table blog_articles.
...
func NewBlogArticlesDao() *BlogArticlesDao {
